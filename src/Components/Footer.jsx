...
function Footer() {
  return (
    <div className='flex w-full h-screen gap-5 p-20 bg-zinc-900 font-["Founders_Grotesk"]'>
        <div className='flex flex-col justify-between w-1/2 h-full '>
         <div className='heading'>
         <h1 className=' font-bold mt-10 leading-none uppercase text-[7vw]'>Eye-</h1>
         <h1 className='-mb-10 leading-none uppercase font-bold text-[7vw]'>Opening</h1>
         </div>
        ...
        <div className='w-1/2'>
        <h1 className=' font-bold -ml-5 mt-10 leading-none  uppercase text-[5.8vw]'>Presentations
        </h1>
        <div className='h-full'>
          <div className='mt-5 -ml-5 dets font-Nueue_Montreal'>
            <h2 className='font-semibold'>S.</h2>
            <a className='block text-xl font-light hover:text-gray-300' href='#'>
              Facebook
            </a>
            <a className='block text-xl font-light hover:text-gray-300' href='#'>
              Instagram
          ...
          <div className='mt-20 -ml-5 dets font-Nueue_Montreal'>
