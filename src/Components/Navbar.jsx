...
function Navbar() {
  ...
  return (
    <div className='fixed z-[999] w-full px-6 md:px-20 py-4 md:py-8 font-["Neue_Montreal"] flex justify-between items-center bg-transparent '>
      {/* Logo */}
      <div className='logo'>
      ...
      <div className="md:hidden">
        <button onClick={toggleMenu} className="focus:outline-none">
          <svg className="w-6 h-6 fill-white current text-" viewBox="0 0 24 24">
            <path
              className={`${isOpen ? 'hidden' : 'block'}`}
              fillRule="evenodd"
              clipRule="evenodd"
              d="M2 5C2 4.44772 2.44772 4 3 4H21C21.5523 4 22 4.44772 22 5C22 5.55228 21.5523 6 21 6H3C2.44772 6 2 5.55228 2 5ZM21 12C21.5523 12 22 12.4477 22 13C22 13.5523 21.5523 14 21 14H3C2.44772 14 2 13.5523 2 13C2 12.4477 2.44772 12 3 12H21ZM21 18C21.5523 18 22 18.4477 22 19C22 19.5523 21.5523 20 21 20H3C2.44772 20 2 19.5523 2 19C2 18.4477 2.44772 18 3 18H21Z"
            />
            <path
              className={`${isOpen ? 'block' : 'hidden'}`}
              fillRule="evenodd"
              clipRule="evenodd"
              d="M4.293 5.293C4.48055 5.10545 4.73482 5 5 5H19C19.2652 5 19.5195 5.10545 19.707 5.293C19.8946 5.48055 20 5.73482 20 6C20 6.26518 19.8946 6.51945 19.707 6.707L12.707 13.707C12.5205 13.8945 12.2662 14 12 14C11.7338 14 11.4795 13.8945 11.293 13.707L4.293 6.707C4.10545 6.51945 4 6.26518 4 6C4 5.73482 4.10545 5.48055 4.293 5.293Z"
            />
          </svg>
      ...
      <div className={`md:flex md:gap-9 md:items-center ${isOpen ? 'block' : 'hidden'} absolute md:relative top-full left-0 w-full md:w-auto bg-zinc-800 md:bg-transparent shadow-md md:shadow-none py-4 md:py-0 px-6 md:px-0`}>
        {['Services', 'Our Work', 'About Us', 'Insights', 'Contact Us'].map((item, index) => (
          <a key={index} className={`block md:text-md capitalize font-light ${index === 4 && 'md:ml-32'} py-2 md:py-0`}>
            {item}
          </a>
        ))}
      </div>
